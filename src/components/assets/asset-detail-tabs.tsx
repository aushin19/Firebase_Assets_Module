...
const formatDate = (dateString?: string): string => {
  ...
  try {
    ...
    if (!isValid(date)) {
       // Try to parse if it's already a Date object from bad mock data
  ...
  return (
    <Tabs defaultValue="overview" className="w-full">
      ...
      <TabsContent value="overview">
        <Card>
          ...
          <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4">
            ...
            <DetailItem label="Network Exposure" value={asset.exposure} icon={<Network className="h-4 w-4" />} />
            ...
            {/* Legacy UI fields, if you want to keep them visible during transition */}
      ...
      <TabsContent value="hardware">
        <Card>
          ...
          <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4">
            ...
            {/* Legacy hardware fields - consider migrating data to hardware.extended or specific hardware spec fields */}
            ...
            {asset.software && asset.software.length > 0 ? (
              <ScrollArea className="h-[300px]">
                <ul className="divide-y divide-border">
                  {asset.software.map((sw, index) => ( // software is the new field name
      ...
      <TabsContent value="security">
         ...
         {/* TODO: Display more fields from asset.security and asset.compliance */}
         <Card className="mt-6">
            <CardHeader>
            ...
            <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4">
                ...
                {/* TODO: List vulnerabilities, security controls, compliance frameworks */}
            </CardContent>
         </Card>
      </TabsContent>
